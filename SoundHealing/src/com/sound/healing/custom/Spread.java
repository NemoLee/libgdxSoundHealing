...
public enum Spread {
	...
	public String getInfoDescription(){
		...
		case INDIVIDUAL:
			...
			return "\nChoose a closed chakra card. Closed chakra card: use the sound on the card to vibrate the chakra and release blocks."
					+"\nChoose an open chakra card. Open chakra card: use the sound to fill the chakra with positive energy, place hands on chakra and send in healing sound to the place where the block has been released."
					...
					+"\nChoose an Angel of Sound card. Angel of Sound: find a sound to connect with this angel and as you tone, visualise pink gold light pouring in through the crown and filling the chakra.";
